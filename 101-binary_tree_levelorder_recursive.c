...
void binary_tree_levelorder(const binary_tree_t *tree, void (*func)(int))
{
	...
	func(tree->n);
	chldrn = get_children(chldrn, tree);
	levels_rec(chldrn, func);
...
void levels_rec(ll *head, void (*func)(int))
{
	...
	{
		func(curr->node->n);
		chldrn = get_children(chldrn, curr->node);
	}
	levels_rec(chldrn, func);
	free_list(chldrn);
}
...
/**
 * get_children - appends chldrn of parent to linked list.
 * @head: Pointer to head of linked list where chldrn will be appended.
 * @parent: Pointer to node whose chldrn we want to append.
 * Return: Pointer to head of linked list of chldrn.
 */
ll *get_children(ll *head, const binary_tree_t *parent)
{
	if (parent->left)
